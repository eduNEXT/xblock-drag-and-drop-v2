...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "\"Maximum items per zone\" should be positive integer, got {max_items_per_zone}": "\"M\u00e1ximo de itens por zona\" deve ser positivo e inteiro. Valor atual: {max_items_per_zone}", 
    "Add a zone": "Adicionar uma zona", 
    "Add an item": "Adicionar um item", 
    "Align dropped items to the left, center, or right.": "Alinhe itens soltos \u00e0 esquerda, centro ou direita.", 
    ...
    "Close": "Fechar", 
    "Continue": "Continuar", 
    "Correct! This one belongs to {zone}.": "Correto! Este item pertence \u00e0 {zone}.", 
    "Correctly placed in: {zone_title}": "Corretamente posicionado em: {zone_title}", 
    "Correctly placed {correct_count} item.": [
      "Item posicionado corretamente: {correct_count}", 
      "Itens posicionados corretamente: {correct_count}"
    ], 
    ...
    "Describe this zone to non-visual users.": "Descreva esta zona para usu\u00e1rios n\u00e3o-visuais.", 
    ...
    "Error feedback": "Coment\u00e1rio de erro", 
    "Failed to parse \"Maximum items per zone\"": "Falha em analisar \"M\u00e1ximo de itens por zona\"", 
    "Feedback": "Coment\u00e1rio", 
    ...
    "For example, 'http://example.com/image.png' or '/static/image.png'.": "Por exemplo, 'http://example.com/image.png' or '/static/image.png'.", 
    ...
    "Image URL (alternative to the text)": "URL da imagem (em substitui\u00e7\u00e3o do texto)", 
    "Image description (should provide sufficient information to place the item even if the image did not load)": "Descri\u00e7\u00e3o da imagem (deve fornecer informa\u00e7\u00e3o suficiente para que se posicione o item mesmo que a imagem n\u00e3o carregue)", 
    ...
    "Items": "Itens", 
    "Keeps maximum score achieved by student": "Mant\u00e9m a pontua\u00e7\u00e3o m\u00e1xima alcan\u00e7ada pelo aluno", 
    ...
    "Misplaced {misplaced_count} item. Misplaced item was returned to item bank.": [
      "Item mal posicionado: {misplaced_count}. O item mal posicionado foi devolvido ao banco de itens. ", 
      "Itens mal posicionados: {misplaced_count}. Os itens mal posicionados foram devolvidos ao banco de itens. "
    ], 
    "Mode": "Modo", 
    "No, this item does not belong here. Try again.": "N\u00e3o, este n\u00e3o \u00e9 o item correto. Tente novamente.", 
    "None": "Nenhum", 
    "Note: do not edit the problem if students have already completed it. Delete the problem and create a new one.": "Observa\u00e7\u00e3o: n\u00e3o edite o problema se os alunoas j\u00e1 o completaram. Apague o problema e crie um novo.", 
    ...
    "Specify preferred width as percentage of the background image width. Leave blank for automatic width.": "Especifique a largura prefer\u00edvel como porcentagem da largura da imagem de plano de fundo. Para largura autom\u00e1tica, deixe o campo em branco.", 
    "Standard": "Padr\u00e3o", 
    ...
    "Submit": "Enviar", 
    "Success feedback": "Coment\u00e1rio de \u00eaxito", 
    "Text": "Texto", 
    ...
    "Use text that is clear and descriptive of the item to be placed.": "Use textos que sejam claros e descritivos sobre o item a ser posicionado.", 
